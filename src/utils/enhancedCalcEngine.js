...
///////////////////////////
function gateFreeze_s(mat, gate, partTh_mm, moldTemp_C, meltTemp_C) {
    const g = estimateGateDims(gate, partTh_mm);
...
function packProfileFromGF(Pinj_bar, gf_s, material, hotRunner) {
...
function clampBar(x) { return Math.min(Math.max(x, 80), 1400); }
///////////////////////////
// 5) Cooling time (semplice ma fisico) + plastificazione
///////////////////////////
function coolingTime_s(material, partTh_mm, moldTemp_C, ejectTemp_C) {
...
function plasticizingTime_s(material, shotVol_cm3, meltTemp_C, machine, regrindPct = 0) {
...
///////////////////////////
function velocityProfile(inputs) {
...
function vToPSwitch_cm3(inputs, cushion_cm3) {
...
///////////////////////////
function machineWarnings(inputs, Pinj_bar, cooling_s, plast_s, cushion_cm3) {
    const w = [];
...
// 8) Clamp force (kN)
///////////////////////////
function clampForce_kN(aprojected_cm2, pack_bar) {
...
// 9) Helper vari
///////////////////////////
function defaultCushion_cm3(shot_cm3) { return Math.max(0.03 * shot_cm3, 0.8); }
function defaultFlowLen_mm(t_mm) { return Math.max(80, 20 * t_mm); }
function approxProjectedArea_cm2(shot_cm3, t_mm) {
...
///////////////////////////
export function computeEnhancedParams(inp) {
...
export * from './enhancedCalcEngine.ts';
